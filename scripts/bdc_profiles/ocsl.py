...
def analyze(ticker, periodA=None, periodB=None):
    ...
    merged['Face_A_M'] = merged['Face_A'].apply(norm)
    merged['Fair_A_M'] = merged['Fair_A'].apply(norm)
    merged['Face_B_M'] = merged['Face_B'].apply(norm)
    merged['Fair_B_M'] = merged['Fair_B'].apply(norm)
